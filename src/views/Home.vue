        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde la base de las relaciones laborales, la administración de salarios se configura como un elemento esencial para garantizar el equilibrio entre empleadores y trabajadores. En este contexto, el sistema de salarios en Colombia no solo regula las modalidades de remuneración, sino también los derechos y beneficios que garantizan condiciones laborales dignas.

              p.descripcion.mb-4 En esta unidad, se estudiará la estructura de los salarios en el país, abarcando elementos constitutivos, modalidades de pago y los beneficios adicionales establecidos por la normativa. Además, se analizarán las implicaciones organizacionales y legales relacionadas con los salarios, promoviendo una comprensión integral que permita a los profesionales aplicar estos conocimientos en la gestión de recursos humanos.
              
              p #[b ¡Prepárese para fortalecer sus habilidades y garantizar prácticas laborales justas y eficientes!]
